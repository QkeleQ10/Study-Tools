...
async function applyStyles() {
    createStyle(`.st-current{background-color:#f0f8ff!important;font-weight:700}.st-obsolete{background-color:#fff0f5!important;font-style:italic}.st-current-sw>div>h3,.st-current-sw>div>h3>b,.st-current-sw>div>div>footer.endlink{background:aliceBlue;font-weight:700}.st-sw-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(14em,1fr));gap:1em;overflow:auto;height:100%}.st-sw-item{background-color:#fafafa;cursor:pointer;display:grid;grid-auto-rows:1fr 1.5em 24px;align-items:center;gap:.3em;padding:1em .5em .3em;aspect-ratio:1/0.75;border-radius:5px;border:1px solid #ccc}.st-current:hover,.st-obsolete:hover,.st-sw-item:hover{filter:brightness(.9)}.st-sw-item:focus{border:2px solid #1f97f9}.st-sw-item h3{overflow:hidden}`, 'study-tools')
