...
if (props.setting.id === 'decoration') {
    decorations = [
        decorations[0],
        {
            ...
            name: "Golven",
            style: {
                'background-image': 'repeating-radial-gradient( circle at 0 0, transparent 0, var(--palette-primary) 19px, transparent 20px ), repeating-linear-gradient( #ffffffbb, #ffffffff )'
            }
        },
        {
            id: 'zig-zag',
            name: "Zigzag",
            style: {
                'background-image': 'linear-gradient(135deg, #ffffffbb 25%, transparent 25%), linear-gradient(225deg, #ffffffbb 25%, transparent 25%), linear-gradient(45deg, #ffffffbb 25%, transparent 25%), linear-gradient(315deg, #ffffffbb 25%, var(--palette-primary) 25%)',
        ...
        },
        {
            ...
            name: "Stippen",
            style: {
                'background-image': 'radial-gradient(#ffffffbb 30%, transparent 31.2%), radial-gradient(#ffffffbb 30%, transparent 31.2%)', 'background-position': '0px 0px, 15px 15px', 'background-size': '30px 30px'
            }
        },
        {
            id: 'stripes',
            name: "Strepen",
            style: {
                'background-image': 'repeating-linear-gradient(45deg, transparent, transparent 10px, #ffffff77 10px, #ffffffcc 20px)'
            }
        },
        {
            id: 'lego',
    ...
    <div class="setting decoration-picker-setting" :title="setting.title">
        ...
        <div class="swatches-wrapper">
            <button v-for="(decoration, i) in decorations" :key="i" class="swatch" :style="decoration.style"
                :title="decoration.name" @click="updateDecoration(decoration.id)"
