...
async function applyStyles() {
    ...
    color-scheme: dark;
        ...
        invertCss = `.clearfix.user-content:not(.st-stopinvert),.content.content-auto.background-white:not(.st-stopinvert){filter:invert(1) hue-rotate(180deg)}.clearfix.user-content:not(.st-stopinvert) p,.comment.ng-binding.ng-scope,.content.content-auto.background-white:not(.st-stopinvert) p{color:#000}.clearfix.user-content:not(.st-stopinvert) iframe,.clearfix.user-content:not(.st-stopinvert) img,.content.content-auto.background-white:not(.st-stopinvert) iframe,.content.content-auto.background-white:not(.st-stopinvert) img{filter:invert(1) hue-rotate(-180deg)}.block .content.background-white{background-color:#ededed}.clearfix.user-content,.content.content-auto.background-white,.content.content-auto.background-white *{font-weight:700}`,
...
${await getSetting('magister-css-dark-auto') ? '}' : ''}`
    ...
    if (await getSetting('magister-css-experimental')) {
        createStyle(rootVars + `.block h3,.block h4{border-bottom:var(--st-widget-border)}.block h4,footer.endlink{box-shadow:var(--st-widget-edges-box-shadow);border-top:var(--st-widget-border)}body,html{height:calc(100vh + 1px)}.k-block,.k-widget,body,div.loading-overlay{background:var(--st-body-background)}.block h3 b{font:var(--st-widget-heading-font);color:var(--st-primary-color)}.block,.content-container,.k-dropdown .k-dropdown-wrap.k-state-default,.studiewijzer-onderdeel>div.block>div.content:not(#studiewijzer-detail-container div,#studiewijzer-detail-container ul){border:var(--st-widget-border);border-radius:var(--st-widget-border-radius)}.content.content-auto.background-white li>span,.content.content-auto.background-white li>strong{color:#000}.agenda-text-icon,.cijfers-k-grid.k-grid .grade.herkansingKolom.heeftonderliggendekolommen,.cijfers-k-grid.k-grid .grade.vrijstellingcolumn,.k-scheduler-weekview .k-scheduler-table .k-today,.k-scheduler-workWeekview .k-scheduler-table .k-today,.ng-scope td.vrijstelling,.versions li.selected,.versions li:hover{background:var(--st-highlight-background)!important;background-color:var(--st-highlight-background)!important}#studiewijzer-detail-container .content>ul.sources,#studiewijzer-detail-container .studiewijzer-onderdeel div.content.coloring-blauw .sources li ul,.block,.block .content,.block .content form,.block h4,.k-dropdown .k-dropdown-wrap.k-state-default,.k-dropdown .k-dropdown-wrap.k-state-hover,.k-grouping-row td,.k-header,.k-multiselect .k-button,.k-multiselect-wrap,.k-resize-handle-inner,.k-scheduler .afspraak *,.k-scheduler .k-event,.k-scheduler .k-event:hover,.k-scheduler-dayview .k-scheduler-table .k-nonwork-hour,.k-scheduler-weekview .k-scheduler-table .k-nonwork-hour,.k-scheduler-workWeekview .k-scheduler-table .k-nonwork-hour,.sm-grid.k-grid .k-grid-content tr,.sm-grid.k-grid .k-grid-content tr.k-state-selected,.sm-grid.k-grid .k-grid-content tr.k-state-selected .k-state-focused,.sm-grid.k-grid .k-grid-content tr.k-state-selected.k-state-focused,.sm-grid.k-grid .k-grid-content tr:hover,.sources li:hover,.studiewijzer-onderdeel>div.block>div.content,.widget .list li.active,.widget .list li.no-data a:hover,.widget .list li.no-data:hover,.widget .list li:hover,.widget li,aside .block .content,dl.list-dl,footer.endlink,table.table-grid-layout th,td.k-group-cell{background:var(--st-primary-background)}.cijfers-k-grid.k-grid .grade.gemiddeldecolumn{background:var(--st-total-background)!important;background-color:var(--st-total-background)!important;color:var(--st-primary-color)!important}.block h3{box-shadow:var(--st-widget-edges-box-shadow)}footer.endlink{border-radius:0 0 8px 8px}.endlink a,table.table-grid-layout td a{color:var(--st-a-color);text-decoration:none}.alert a:hover,.k-dropdown .k-dropdown-wrap.k-state-hover,.k-scheduler-dayview .k-scheduler-header .k-scheduler-table th,.k-scheduler-weekview .k-scheduler-header .k-scheduler-table th,.k-scheduler-workWeekview .k-scheduler-header .k-scheduler-table th,table.table-grid-layout tr:hover{background-color:var(--st-primary-background)!important;box-shadow:none!important}.cijfers-k-grid.k-grid .grade.herkansingKolom{background-color:var(--st-primary-background)!important;color:var(--st-primary-color)!important}#cijfers-container .main div.content-container-cijfers,.cijfers-k-grid.k-grid .grade.empty,.cijfers-k-grid.k-grid .k-grid-content,.cijfers-k-grid.k-grid .k-grid-header th.k-header,table,table.table-grid-layout td{background:var(--st-body-background)!important;color:var(--st-primary-color);border-color:var(--st-primary-border-color)!important}.k-grid-header,.k-multiselect .k-button,.k-multiselect.k-header,.studiewijzer-onderdeel div.content ul>li,.widget li,dl.list-dl dd,dl.list-dl dt,table *{border-color:var(--st-primary-border-color)!important}.k-dropdown-wrap.k-state-hover,.k-scheduler .k-event:hover,.sm-grid.k-grid .k-grid-content tr:hover,.sources li:hover,.widget .list li.active,.widget .list li.no-data a:hover,.widget .list li.no-data:hover,.widget .list li:hover,table.table-grid-layout tr:hover{filter:brightness(.8);transition:filter .2s}.widget .list li.no-data a:hover,.widget .list li.no-data:hover{cursor:default}.tabs,.widget .list{border-bottom:var(--st-widget-border)}.widget .list li{border-top:var(--st-widget-border)}.block .content .title,.block h4,.k-dropdown-wrap .k-input,.k-scheduler-dayview .k-scheduler-table td,.k-scheduler-dayview .k-scheduler-table th,.k-scheduler-dayview .k-scheduler-times table.k-scheduler-table th strong,.k-scheduler-weekview .k-scheduler-table td,.k-scheduler-weekview .k-scheduler-table th,.k-scheduler-weekview .k-scheduler-times table.k-scheduler-table th strong,.k-scheduler-workWeekview .k-scheduler-table td,.k-scheduler-workWeekview .k-scheduler-table th,.k-scheduler-workWeekview .k-scheduler-times table.k-scheduler-table th strong,.studiewijzer-onderdeel div.content ul.sources ul>li>a,.subtitle,.tabs li a,.widget .list li a,a,a.ng-binding,dd,span:not(.caption,.k-dropdown),dl.list-dl dd,dl.list-dl dt,dna-breadcrumb,dt,fieldset label,form label,h4,label,p,strong,td,th{font-family:var(--st-secondary-font-family);color:var(--st-primary-color)}.menu a,.menu a span{color: #fff!important}.k-scheduler .afspraak .afspraak-info>.title .schoolHour,span.nrblock{background:var(--st-primary-color)!important;color:var(--st-primary-background)!important;font-family:var(--st-secondary-font-family)}.endlink a:first-letter{text-transform:uppercase}.endlink a{text-decoration:none;translate:-2px -2px}.endlink a:hover{filter:brightness(.8)}.widget .endlink a:after{content:'⏵';font-size:16px;position:relative;top:1px;left:2px}.menu-footer,.appbar>div>a,a.appbar-button{background:var(--primary-background)}`, 'study-tools-general')
